...
| `To-dos Page Redesign.dc.html` | The To-dos page: week-progress + day-spine header, grouping by when it's owed, one compact row with a per-person filter, drawer for steps/trail, docked bulk bar | **Shipped as v2.16** (both copies) — see the v2.16 changelog entry |
