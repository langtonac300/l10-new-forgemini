// ═════════════════════════════════════════════════════════════════════════
// MOMENTUM HUDDLE DATA HEALTH — the metrics check their sources before the room reads them.
// ═════════════════════════════════════════════════════════════════════════
...
function l10_dataHealth(force) {
  try {
    ...
    // Cache the failure briefly too — without this, every metrics render in
