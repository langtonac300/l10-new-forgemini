...
| `Shift` | Free text — the strategic shift or theme this serves. The field suggests the current FY27 four shifts (`Shift 1`…`Shift 4`, the same vocabulary as Rocks) plus anything already typed, but nothing is forced: next year's themes get named here while the goals are still being generated (Alex, 2026-09-15) |
